...
"""
outils/qemu_bcch_grgsm.py — pont gr-gsm : I/Q DL du BTS (tee qemu) → bursts → demapper
...
Usage : source /root/.env/bin/activate ; python outils/qemu_bcch_grgsm.py
    ...
    while True:
        ...
        if (fn % 51) in (2, 3, 4, 5) and dbg_tsc[0] < 24:
            ...
            if len(dbg_dump) >= 8:
                ...
                _np.savez(f"{GSM_ROOT}/live_bursts.npz", **d)
