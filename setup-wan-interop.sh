...
#
# Usage :
#   sudo ./setup-wan-interop.sh <local_public_ip> <remote_public_ip> [n_operators]
#
# Exécuter sur CHAQUE serveur avec les IPs inversées :
#   Serveur A : sudo ./setup-wan-interop.sh 82.66.231.141 37.59.111.84 2
#   Serveur B : sudo ./setup-wan-interop.sh 37.59.111.84 82.66.231.141 2
# ══════════════════════════════════════════════════════════════════════════════
...
; Généré par setup-wan-interop.sh le $(date '+%Y-%m-%d %H:%M:%S')
; ══════════════════════════════════════════════════════════════════════════════
"
